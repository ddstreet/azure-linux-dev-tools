...
//	Generated commit TOML (3 changes): S0 (on C1), S1 (on C3), S2 (on C3)
//
...
`
	...
	patched := strings.Replace(string(azldevToml),
		"includes = [",
		"includes = [\"local-distro.toml\", \"base/upstream-commits/*.toml\", ",
		1,
	)
	...
	// 2. Commits the generated upstream-commit TOML three times to
...
# --- Create upstream commit TOML history ---
...
mkdir -p project/base/upstream-commits
cd project

# Commit TOML change 0: initial import while upstream was at C1 (v1.0 era).
...
cat > base/upstream-commits/test-pkg.toml <<EOF
...
[components.test-pkg.spec]
upstream-commit = "$FIRST_COMMIT"
EOF
git add base/upstream-commits/test-pkg.toml
git -c commit.gpgsign=false commit -m "Import test-pkg at v1.0"

# Commit TOML change 1: updated to latest upstream
cat > base/upstream-commits/test-pkg.toml <<EOF
# This file was generated by 'azldev component refresh-upstream-commit'
# Do not edit this file, changes will be lost
# For more details see 'azldev component refresh-upstream-commit --help'
...
# Refreshed after component customization.
EOF
git add base/upstream-commits/test-pkg.toml
git -c commit.gpgsign=false commit -m "Update test-pkg to v1.1"

# Commit TOML change 2: simulated refresh
cat > base/upstream-commits/test-pkg.toml <<EOF
# This file was generated by 'azldev component refresh-upstream-commit'
# Do not edit this file, changes will be lost
# For more details see 'azldev component refresh-upstream-commit --help'
...
EOF
git add base/upstream-commits/test-pkg.toml
git -c commit.gpgsign=false commit -m "Refresh generated upstream commit"
