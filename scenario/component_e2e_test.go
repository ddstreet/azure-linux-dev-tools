...
const (
	...
	// respect to 'azldev component refresh-upstream-commit -a' and 'azldev component render -a
...
// with full history. 'component refresh-upstream-commit' does not walk history and is fine
...
// 'azldev component refresh-upstream-commit -a' against an upstream microsoft/azurelinux
...
// 'refresh-upstream-commit -a' is a no-op.
//
...
func TestAzureLinuxComponentUpdateIsIdempotent(t *testing.T) {
	...
	runAzureLinuxIdempotencyTest(t, []string{"component", "refresh-upstream-commit", "-a"}, false)
}
