...
`
	...
	assert.Equal(t, "legacy-locks", config.Project.DeprecatedLockDir)
}
...
`},
		{"/project/include.toml", `# This file was generated by 'azldev component refresh-upstream-commit'
...
func TestLoadAndResolveProjectConfig_ValidatesComponentsAfterMerge(t *testing.T) {
	testFiles := []struct {
		path     string
		contents string
	}{
...
func TestLoadAndResolveProjectConfig_RejectsInvalidComponentAfterMerge(t *testing.T) {
	const configContents = `# This file was generated by 'azldev component refresh-upstream-commit'
# Do not edit this file, changes will be lost
# For more details see 'azldev component refresh-upstream-commit --help'
[components.abc.spec]
upstream-commit = "abcdef1234567"
...
func TestLoadAndResolveProjectConfig_ComponentDefinitionOverridesEarlierGeneratedCommit(t *testing.T) {
	testFiles := []struct {
		path     string
		contents string
	}{
...
`},
		{"/project/generated.toml", `# This file was generated by 'azldev component refresh-upstream-commit'
# Do not edit this file, changes will be lost
# For more details see 'azldev component refresh-upstream-commit --help'
[components.abc.spec]
upstream-commit = "abcdef1234567"
