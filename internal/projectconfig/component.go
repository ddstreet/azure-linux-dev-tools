...
type ComponentConfig struct {
	...
	// in serialized files.
	SourceConfigFile *ConfigFile `toml:"-" json:"-" table:"-" validate:"-"`
	...
	Tests *ComponentTestsConfig `toml:"tests,omitempty" json:"tests,omitempty" table:"-" jsonschema:"title=Tests,description=Per-component test or test-group references"`
}
