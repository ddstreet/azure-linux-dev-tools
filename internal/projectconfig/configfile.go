...
// GeneratedUpstreamCommitMarker identifies component TOML emitted by
// "azldev component update-upstream-commit".
const GeneratedUpstreamCommitMarker = "# Generated by azldev component update-upstream-commit."

const legacyGeneratedUpstreamCommitMarker = "# Generated by azldev component update."
...
type ConfigFile struct {
	...
	generatedUpstreamCommitOverride bool   `toml:"-"`
}
...
func (f ConfigFile) Validate() error {
	...
	// multiple competing snapshot policies for generated upstream commits.
